 ...
 * =====================================================================================
 *
 *       Filename:  OpenCLLineRasterizer.cpp
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  2012/3/4 15:02:05
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
#include "OpenCLLineRasterizer.hpp"
...
namespace my_gl {
     ...
     OpenCLLineRasterizer::OpenCLLineRasterizer
     ...
     {
	  CLSource clSource("BatchLineRasterizer.cl");
     ...
     void OpenCLPointRasterizer::chooseKernel()
     {
	  ...
	  {
	       {GL_ALWAYS,"orderRasterize"},
	       {GL_LESS,"lessRasterize"},
	       {GL_LEQUAL,"lessEqualRasterize"},
	       {GL_EQUAL,"equalRasterize"},
	       {GL_NOTEQUAL,"notEqualRasterize"},
	       {GL_GREATER,"greaterRasterize"},
	       {GL_GEQUAL,"greaterEqualRasterize"}
	  };
